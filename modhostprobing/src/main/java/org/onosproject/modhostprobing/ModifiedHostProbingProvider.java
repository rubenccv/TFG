...
package org.onosproject.modhostprobing;
...
public class ModifiedHostProbingProvider extends AbstractProvider implements HostProvider, HostProbingProvider {
     ...
     */
    public ModifiedHostProbingProvider() {
